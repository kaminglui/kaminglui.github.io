...
- **Entry HTML:** `index.html`, `pages/circuit-lab/index.html`, `pages/transformer-lab/index.html`, `pages/ml-playground/index.html`, `pages/fourier-epicycles/index.html` (build), `pages/endless-depths/index.html`. The Vite source app also has its own `index.html` for dev builds.
...
- **Renderer:** `assets/js/site-footer.js`
  - Data from `assets/js/config/footerPresets.js` (`FOOTER_PRESETS`, `DEFAULT_META`); presets for `home`, `ml-playground`, `transformer-lab`, `endless-depths`.
...
- `pages/endless-depths/index.html`: calls `initMainLayout('endless-depths')`; uses endless-depths footer preset.
...
- Footer preset variants for `ml-playground`, `transformer-lab`, `endless-depths`; default `home` preset elsewhere.
